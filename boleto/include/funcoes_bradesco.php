...
$nossonumero = substr($nnum,0,2).'/'.substr($nnum,2).'-2';
...
//Guarda inicial
?><img src="boleto/imagens/p.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0"><img src="boleto/imagens/b.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0"><img src="boleto/imagens/p.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0"><img src="boleto/imagens/b.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0"><img 
<?php 
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
  $texto = "0" . $texto;
